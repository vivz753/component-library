...
const Bar = (props) =>
(
  <div className={`rounded border border-m1`} />
  )
...
const DrawerContainer = (props) => (
  <div
    ref={props.ref}
    className={`pt-[48px] flex fixed bg-white shadow-m3-lg overflow-visible w-full h-auto z-30 transition-all duration-1000 ease-in-out opacity-0 transform ${props.toggle ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"}`} 
  >
    {props.children}
  </div>
)
